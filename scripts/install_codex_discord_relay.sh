...
RELAY_TASKS_ENABLED=${RELAY_TASKS_ENABLED:-true}
RELAY_TASKS_MAX_PENDING=${RELAY_TASKS_MAX_PENDING:-50}
RELAY_TASKS_STOP_ON_ERROR=${RELAY_TASKS_STOP_ON_ERROR:-false}
RELAY_TASKS_POST_FULL_OUTPUT=${RELAY_TASKS_POST_FULL_OUTPUT:-true}
RELAY_WORKTREE_ROOT_DIR=${RELAY_WORKTREE_ROOT_DIR:-$STATE_DIR/worktrees}
...
RELAY_CONTEXT_ENABLED=${RELAY_CONTEXT_ENABLED:-true}
RELAY_CONTEXT_EVERY_TURN=${RELAY_CONTEXT_EVERY_TURN:-true}
RELAY_CONTEXT_VERSION=${RELAY_CONTEXT_VERSION:-1}
RELAY_CONTEXT_FILE="${RELAY_CONTEXT_FILE:-/root/.codex-discord-relay/global-context.md;tail:docs/WORKING_MEMORY.md;tail:HANDOFF_LOG.md;tail:/root/SYSTEM_SETUP_WORKING_MEMORY.md;tail:/root/HANDOFF_SUMMARY_FOR_NEXT_CODEX.txt}"
RELAY_CONTEXT_MAX_CHARS=${RELAY_CONTEXT_MAX_CHARS:-40000}
RELAY_CONTEXT_MAX_CHARS_PER_FILE=${RELAY_CONTEXT_MAX_CHARS_PER_FILE:-20000}
