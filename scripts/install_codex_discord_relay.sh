...
RELAY_CONTEXT_FILE="${RELAY_CONTEXT_FILE:-/root/.codex-discord-relay/global-context.md;tail:docs/WORKING_MEMORY.md;tail:HANDOFF_LOG.md}"
RELAY_CONTEXT_MAX_CHARS=${RELAY_CONTEXT_MAX_CHARS:-6000}
RELAY_CONTEXT_MAX_CHARS_PER_FILE=${RELAY_CONTEXT_MAX_CHARS_PER_FILE:-2000}
